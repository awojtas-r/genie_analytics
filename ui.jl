...
cell(style="background-color: #263238; padding: 10px 50px; color: #ffffff; top: 0; width: 100%;", [
    ...
    a(href="/", style="padding: 10px; font-size: 12px; color: #ffffff; text-decoration: none;", "Dashboards"),
    a(href="/", style="padding: 10px; font-size: 12px; color: #ffffff; text-decoration: none;", "Contact")
    ])
  ])
])
    row([
